...
<head>
    ...
    <title>Borrow book in My Library System</title>
</head>
<body>
...
<!--- the codes for borrow books begins from here---->
<?php
...
if (isset($_POST['borrow'])) {
    ...
    {
        die("<div class='borrFailed'>You already borrowed this book. Please handle it with care and return it on the due date you stated. </div>   <div class='gobackButn'><i class='fa-solid fa-arrow-left'></i><a href='books.php'> Go back to book shelf</a></div>");
    }
    ...
    echo"<div class='borrSuccess'>
        <i class='fa-solid fa-check'></i> You have currently borrowed this book titled <br><strong><em>$book_title</em></strong>.
    </div>";
...
?>
        ...
        <h2>CHANGE YOUR TOMORROW THROUGH READING</h2><br>
            <h2>Kindly Fill The Below to Borrow Book</h2>
            <form action="<?php 
    ...
    if (isset($_POST['borrow'])) {
        $book_id = $_POST['book_id'];
            ...
            ?>" method="POST">
                <label>Your name (As it appears on your student ID)</label>
                <input type="text" name="borrowed_by_name" placeholder="Your full name as it appears on your ID" value="<?php echo"$fname";?>" readonly>

                <label>What date are you borrowing this book?</label>
                <input type="date" name="borrow_date" >
                
                <label>What date would you return this book?</label>
                <input type="date" name="returning_date" >

                <div class="agreeHolder">
                    <label><input type="checkbox" name="agree" required> I wholy accept to be prosecuted in accordance with the institutions policy if failed to return a borrowed book at the above set date</label>
                </div>
        ...
        <input type="hidden" name="book_id" value="<?php echo"$book_id";?>"   id="book_id" >
            ...
            <div class="gobackButn"><i class="fa-solid fa-arrow-left"></i><a href="books.php"> return to my shelf</a></div>
        </div>
    </div>
</div>

<!--- codes for borrowing book ends at this spot---->
