...
<head>
    ...
    <title>Replace Cover photo in Library Management System</title>
</head>
<body>
...
<div class="pageArea">
    <div class="greetingsTab">
        <h2><i class="fa-solid fa-book"></i> Manage Books In The Library Management System</h2>
        <p>Below is list of all registered books in the library System.</p>
	...
	$extension = end($temp);
		  ...
		  && in_array($extension, $allowedExts))
			...
			{
				die("Invalid image format, try again!");
			}
