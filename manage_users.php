...
<head>
    ...
    <title>Manage Users Library System System</title>
</head>
...
<body>
    ...
    <div class="pageArea">
        <div class="greetingsTab">
            ...
            <p>Below is list of all registered books in the library Management System.</p>
        ...
        <div class="recentlyRead">
            ...
            if ($users_count > 1) {
                echo "<h2>$users_count Registered users </h2>";
            } else {
