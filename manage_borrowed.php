...
<head>
    ...
    <title>Manage BorrowedLibrary Management System</title>
</head>
<body>
...
<div class="pageArea">
    <div class="greetingsTab">
        <h2><i class="fa-solid fa-book"></i> Borrowed Books</h2>
        <p>Below is the status of all borrowed books in the library management system.</p>
