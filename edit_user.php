...
<head>
    ...
    <title>Edit User in Library Management System</title>
</head>
...
<body>
    ...
    <div class="mobileMenuTray">
        <ul>
            <li><a href="dashboard.php"> DASHBOAD <i class="fa-solid fa-house"></i></a></li>
            ...
            <div class='bookbriefHolder'>
                ...
                if (isset($_POST['save'])) {
                    ...
                    if ($password == "$confirm_password") {
                        ...
                        <i class='fa-solid fa-face-frown'></i> error, Password confirmation doesn't match, try again.
                        </div>");
                    }
                ...
                <div class="formHolder2">
                    ...
                    <form action="<?php echo "edit_user.php?user_id=$user_id"; ?>" method="POST">
                        ...
                        <div class="loginStatus">Carefully complete the form below to user account!</div>
