...
<head>
    ...
    <title>My LIbrary System Add Book</title>
</head>
...
<body>
    ...
    <div class="pageArea">
        <div class="greetingsTab">
            <h2 style="text-align:center; color: green"> MANAGE BOOKS IN LIBRARY</h2>
            <p>The Underlisted books are all registered books in the library Management System.</p>
            ...
            <div class="shortMenu">
                <div class="formArea">
                    <form action="search_book.php" method="GET">
                        ...
                        <button type="submit" name="search"></i> Search</button>
                    </form>
                </div>

                <div class="sideMenu">
                    <div class="menuTB"><a href="manage_users.php">Manage Library Users</a></div>
                    <div class="menuTB"><a href="manage_books.php">Manage Library Books</a></div>
                    <div class="menuTB"><a href="manage_borrowed.php">Borrowed Library Books</a></div>
                </div>
            </div>
        </div>
        ...
        <div class='hangingPreview3'>
            ...
            <div class='bookbriefHolder'>
                <h2 style="color: green">ADD NEW BOOK</h2>
                ...
                <div class="formHolder">
                    <h2>+ REGISTER NEW BOOK IN LIBRARY MANAGEMENT SYSTEM</h2>
                    <form action="<?php echo "add_book.php"; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="book_genre" required>
                            <option value="0">- Select book genre below -</option>
                            <option>History</option>
                            <option>Fiction</option>
                        ...
                        <div class="agreeHolder">
                            <label><input type="checkbox" name="agree" required> To continue, click the box to accept the terms of services in
                                this library management system</label>
                        </div>
